...
#[cfg(feature = "f32")] use crate::float::{ceil, floor};
#[cfg(not(feature = "f32"))]
...
#[cfg(feature = "f32")]
mod sampled {
    use super::{CoverageSink, FillRule};
...
#[cfg(feature = "f32")]
pub use sampled::{Intersection, RasterError, RasterOptions, RasterWorkspace, rasterize_edges};
#[cfg(feature = "f32")]
pub(crate) use sampled::{checked_width, emit_coverage_runs};
