...
use crate::{color::SRGBA,
    ...
    float::{dash::{dash_polyline, DashPattern}, raster::{Intersection, RasterError,
        RasterOptions, RasterWorkspace, rasterize_edges}},
    ...
    raster::{CoverageMask, CoverageMaskMut, CoverageSink, FillRule,
        MaskClipSink, RectClipSink, clip_region, rect_is_integer,
...
#[cfg(test)] use crate::render::{blend_solid_bytes, solid_blend_terms};
